            ...
            <div className="flex flex-col w-full lg:w-1/2">
              <div className="flex justify-center mt-5 font-bold text-3xl">
                  <ul className="flex items-end">
                    ...
                    <li className="mt-2 text-sm ml-3 mb-1">次のレベルまで<span className="text-green-500">■</span>×10</li>
                  </ul>
              </div>
              <div className="mt-10 font-bold flex flex-col text-center">
                <a href="#" className="text-2xl">本日の戦闘力<span className="text-3xl">199</span>万</a>
